...
export class ModuleApi {
    ...
    public findById(id: number | any ): Observable<ModuleVO | any> {
        ...
        return this.http.get<ModuleVO | any>(this.path + `/${id}/{id}`);
    }

    public findCurriculumModules(moduleId: number | any ): Observable<ModuleListVO | any> {

        return this.http.get<ModuleListVO | any>(this.path + `/module/${moduleId}/module/{moduleId}`);
    }
