...
import bw.co.roguesystems.thutego.access.AccessPoint;
import bw.co.roguesystems.thutego.access.AccessPointListDTO;
import bw.co.roguesystems.thutego.access.AccessPointRepository;
import bw.co.roguesystems.thutego.access.type.AccessPointType;
import bw.co.roguesystems.thutego.access.type.AccessPointTypeRepository;
    ...
    extends AuthorisationDaoBase
{
        ...
        AuthorisationDTO target)
    {
        ...
        // WARNING! No conversion for target.accessPoint (can't convert source.getAccessPoint():bw.co.roguesystems.thutego.access.AccessPoint to bw.co.roguesystems.thutego.access.AccessPointListDTO
        ...
        AuthorisationListDTO target)
    {
        ...
        // WARNING! No conversion for target.accessPoint (can't convert source.getAccessPoint():bw.co.roguesystems.thutego.access.AccessPoint to java.lang.String
        if(source.getAccessPoint() != null)
        {
