 ...
 * MODEL CLASS: AndroMDAModel::backend::bw.co.roguesystems.thutego::access::AccessPointService
 * STEREOTYPE:  Service
 */
package bw.co.roguesystems.thutego.access;
...
/**
 * @see bw.co.roguesystems.thutego.access.AccessPointService
 */
    ...
    extends AccessPointServiceBase
{
     ...
     */
    @Override
    protected AccessPointDTO handleFindById(Long id)
            throws Exception {
