...
import bw.co.roguesystems.thutego.curriculum.outcome.ExitLevelOutcome;
import bw.co.roguesystems.thutego.curriculum.outcome.ExitLevelOutcomeDaoBase;
    ...
    extends ExitLevelOutcomeDaoBase
{
    ...
    private ExitLevelOutcome loadExitLevelOutcomeFromExitLevelOutcomeVO(ExitLevelOutcomeVO exitLevelOutcomeVO)
    {
        ...
        throw new UnsupportedOperationException("bw.co.roguesystems.thutego.curriculum.outcome.loadExitLevelOutcomeFromExitLevelOutcomeVO(ExitLevelOutcomeVO) not yet implemented.");
